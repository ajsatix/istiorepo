...
logSummary() {
    ...
    echo "Gateway - http://store.jhipster-demo.35.202.31.14.nip.io"
    echo "Zipkin - http://zipkin.istio-system.35.202.31.14.nip.io"
    echo "Grafana - http://grafana.istio-system.35.202.31.14.nip.io"
    echo "Kiali - http://kiali.istio-system.35.202.31.14.nip.io"
    echo "#####################################################"
}

default() {
    kubectl apply -f namespace.yml
    kubectl label namespace jhipster-demo istio-injection=enabled --overwrite=true
