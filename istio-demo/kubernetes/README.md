...
```
$ docker image tag store gcr.io/kloudlearn-staging/store
$ docker push gcr.io/kloudlearn-staging/store
$ docker image tag invoice gcr.io/kloudlearn-staging/invoice
$ docker push gcr.io/kloudlearn-staging/invoice
$ docker image tag notification gcr.io/kloudlearn-staging/notification
$ docker push gcr.io/kloudlearn-staging/notification
$ docker image tag product gcr.io/kloudlearn-staging/product
$ docker push gcr.io/kloudlearn-staging/product
```
...
```
$ kubectl get svc store -n jhipster-demo
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n jhipster-demo
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n jhipster-demo
```
